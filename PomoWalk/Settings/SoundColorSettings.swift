...
class SoundColorSettings {
    ...
    static var colorSchemes: [DropdownOption] {
        var schemes = [DropdownOption(title: "Lemonade", isSelected: false), DropdownOption(title: "Nature", isSelected: false), DropdownOption(title: "Blueberry", isSelected: false), DropdownOption(title: "Frozen", isSelected: false)]
